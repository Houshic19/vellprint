...
const sqliteDbJsPath = path.join(__dirname, '../src/config/sqlite_db.js');

let sqliteCode = `const Database = require('better-sqlite3');
const path = require('path');
...
fs.writeFileSync(sqliteDbJsPath, sqliteCode);
console.log('Generated sqlite_db.js successfully!');
